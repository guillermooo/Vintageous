...
class Test_vi_l(BufferTest):
    def testCanMoveInNormalMode(self):
        ...
        self.view.run_command('_vi_h', {'mode': MODE_NORMAL, 'count': 1, 'extend': False})
    ...
    def testCanMoveInInternalNormalMode(self):
        ...
        self.view.run_command('_vi_h', {'mode': _MODE_INTERNAL_NORMAL, 'count': 1, 'extend': False})
    ...
    def testCanMoveInNormalModeWithCount(self):
        ...
        self.view.run_command('_vi_h', {'mode': MODE_NORMAL, 'count': 10, 'extend': False})
    ...
    def testCanMoveInInternalNormalModeWithCount(self):
        ...
        self.view.run_command('_vi_h', {'mode': _MODE_INTERNAL_NORMAL, 'count': 10, 'extend': False})
    ...
    def testCanMoveInVisualMode(self):
        ...
        self.view.run_command('_vi_h', {'mode': MODE_VISUAL, 'count': 1, 'extend': False})
    ...
    def testCanMoveInVisualModeWithCount(self):
        ...
        self.view.run_command('_vi_h', {'mode': MODE_VISUAL, 'count': 10, 'extend': False})
    ...
    def testStopsAtLeftEndInNormalMode(self):
        ...
        self.view.run_command('_vi_h', {'mode': MODE_NORMAL, 'count': 10000, 'extend': False})
        self.assertEqual(self.R(0, 0), first_sel(self.view))
    ...
    def testStopsAtLeftEndInVisualMode(self):
        ...
        self.view.run_command('_vi_h', {'mode': MODE_VISUAL, 'count': 10000, 'extend': False})
        self.assertEqual(self.R(2, 0), first_sel(self.view))
    ...
    def testStopsAtLeftEndInInternalNormalMode(self):
        ...
        self.view.run_command('_vi_h', {'mode': _MODE_INTERNAL_NORMAL, 'count': 10000, 'extend': False})
