...
# class Test_vi_s_InNormalMode(BufferTest):
...
# class Test_vi_s_InInternalNormalMode(BufferTest):
...
# class Test_vi_s_InVisualMode(BufferTest):
...
# class Test_vi_s_InVisualLineMode(BufferTest):
#     def testCanMove(self):
#         set_text(self.view, 'abc\ndef')
