...
class Test_vi_k_InNormalMode(BufferTest):
    def testMoveOne(self):
        ...
        self.view.run_command('_vi_k_motion', {'mode': MODE_NORMAL, 'count': 1, 'xpos': 1})
    ...
    def testMoveMany(self):
        ...
        self.view.run_command('_vi_k_motion', {'mode': MODE_NORMAL, 'count': 2, 'xpos': 1})
    ...
    def testMoveOntoShorterLine(self):
        ...
        self.view.run_command('_vi_k_motion', {'mode': MODE_NORMAL, 'count': 1, 'xpos': 5})
    ...
    def testMoveFromEmptyLineToEmptyLine(self):
        ...
        self.view.run_command('_vi_k_motion', {'mode': MODE_NORMAL, 'count': 1, 'xpos': 0})
    ...
    def testMoveTooFar(self):
        ...
        self.view.run_command('_vi_k_motion', {'mode': MODE_NORMAL, 'count': 100, 'xpos': 1})
...
#         self.view.run_command('_vi_k_motion', {'mode': MODE_VISUAL, 'count': 50, 'xpos': 1})
...
#         self.view.run_command('_vi_k_motion', {'mode': MODE_VISUAL, 'count': 1, 'xpos': 5})
...
#         self.view.run_command('_vi_k_motion', {'mode': MODE_VISUAL, 'count': 10000, 'xpos': 1})
...
#         self.view.run_command('_vi_k_motion', {'mode': _MODE_INTERNAL_NORMAL, 'count': 1, 'xpos': 1})
...
#         self.view.run_command('_vi_k_motion', {'mode': _MODE_INTERNAL_NORMAL, 'count': 50, 'xpos': 1})
...
#         self.view.run_command('_vi_k_motion', {'mode': _MODE_INTERNAL_NORMAL, 'count': 1, 'xpos': 5})
...
#         self.view.run_command('_vi_k_motion', {'mode': _MODE_INTERNAL_NORMAL, 'count': 1, 'xpos': 0})
...
#         self.view.run_command('_vi_k_motion', {'mode': _MODE_INTERNAL_NORMAL, 'count': 10000, 'xpos': 1})
...
#         self.view.run_command('_vi_k_motion', {'mode': MODE_VISUAL_LINE, 'count': 1, 'xpos': 1})
...
#         self.view.run_command('_vi_k_motion', {'mode': MODE_VISUAL_LINE, 'count': 50, 'xpos': 1})
...
#         self.view.run_command('_vi_k_motion', {'mode': MODE_VISUAL_LINE, 'count': 1, 'xpos': 0})
...
#         self.view.run_command('_vi_k_motion', {'mode': MODE_VISUAL_LINE, 'count': 10000, 'xpos': 1})
