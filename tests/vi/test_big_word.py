...
class Test_next_big_word_start_InNormalMode_FromWordStart(BufferTest):
    def testToWordStart(self):
        set_text(self.view, '(foo) bar\n')
        r = self.R((0, 0), (0, 0))
        add_sel(self.view, r)
...
class Test_next_big_word_start_InNormalMode_FromWord(BufferTest):
    def testToWordStart(self):
        set_text(self.view, '(foo) bar\n')
        r = self.R((0, 1), (0, 1))
        add_sel(self.view, r)
...
class Test_next_big_word_start_InNormalMode_FromPunctuationStart(BufferTest):
    def testToWordStart(self):
        set_text(self.view, ':foo\n')
        r = self.R((0, 0), (0, 0))
        add_sel(self.view, r)
...
class Test_next_big_word_start_InNormalMode_FromEmptyLine(BufferTest):
    def testToWordStart(self):
        set_text(self.view, '\nfoo\n')
        r = self.R((0, 0), (0, 0))
        add_sel(self.view, r)
...
class Test_next_big_word_start_InNormalMode_FromPunctuation(BufferTest):
    def testToWordStart(self):
        set_text(self.view, '::foo\n')
        r = self.R((0, 1), (0, 1))
        add_sel(self.view, r)
...
class Test_next_big_word_start_InInternalNormalMode_FromWhitespace(BufferTest):
    def testToWhitespaceLine(self):
        set_text(self.view, '  \n  ')
        r = self.R((0, 0), (0, 0))
        add_sel(self.view, r)
...
class Test_next_big_word_start_InInternalNormalMode_FromWordStart(BufferTest):
    def testToWhitespaceLine(self):
        set_text(self.view, 'foo\n  ')
        r = self.R((0, 0), (0, 0))
        add_sel(self.view, r)
...
class Test_next_big_word_start_InInternalNormalMode_FromWord(BufferTest):
    def testToWhitespaceLine(self):
        set_text(self.view, '(foo)\n  ')
        r = self.R((0, 1), (0, 1))
        add_sel(self.view, r)
...
class Test_next_big_word_start_InInternalNormalMode_FromPunctuationStart(BufferTest):
    def testToWhitespaceLine(self):
        set_text(self.view, '.\n  ')
        r = self.R((0, 0), (0, 0))
        add_sel(self.view, r)
...
class Test_next_big_word_start_InInternalNormalMode_FromPunctuation(BufferTest):
    def testToWhitespaceLine(self):
        set_text(self.view, '::\n  ')
        r = self.R((0, 1), (0, 1))
        add_sel(self.view, r)
...
class Test_next_big_word_start_InInternalNormalMode_FromEmptyLine(BufferTest):
    def testToWhitespaceLine(self):
        set_text(self.view, '\n  ')
        r = self.R((0, 0), (0, 0))
        add_sel(self.view, r)
